...
function ProductItemHot() {
    return (
        <div className="grid grid-cols-4 gap-6">
            <div className='border-2 border-gray-200 rounded-lg relative bg-white cursor-pointer'>
                ...
                <div className="mx-3">
                    <div className="text-sm font-bold hover:text-red-700">iPhone 15 128GB - Chính hãng VN/A Chính hãng VN/A</div>
                    <div className='flex flex-row justify-between mt-2'>
                        <div className='text-sm font-bold text-red-700'>19.999.000đ</div>
                        <div className='text-sm font-medium line-through'>99.999.000đ</div>
                    </div>
