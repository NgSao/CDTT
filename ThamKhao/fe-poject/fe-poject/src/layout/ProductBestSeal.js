...
function ProductBestSeal() {
    ...
    return (
        <div className=' grid '>
            <h1 className=" text-2xl font-bold my-10 mx-5 place-self-center md:place-self-start">Product sold well in a month</h1>
                    ...
                    >
                        ...
                        <div className="mt-2 text-center">
                            ...
                            <div className='flex place-content-between px-5'>
                                ...
                                <p className="text-gray-600 line-through">{product.product_price}$</p>
